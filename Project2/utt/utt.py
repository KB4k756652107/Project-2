...
board_num = 0
boards = {f"board{index}": [" " for _ in range(9)] for index in range(10)}
p1_p2 = "x"
play = True

def reset(play_again = False):
    gap = " "*22
    if input(f"{gap}Want to play again? [y/n]: ").lower() == "y":
        play_again = True
    return play_again, 0, {f"board{index}": [" " for _ in range(9)] for index in range(10)}, "x"
...
while play == True:
    ...
    play, board_num, boards, p1_p2 = reset()

# print(5 * '\n') """This was for recording"""
